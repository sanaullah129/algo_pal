...
def get_env_config() -> Dict[str, Any]:
    ...
    return {
        ...
        "AZURE_OPENAI_API_VERSION": os.getenv("AZURE_OPENAI_API_VERSION") or os.getenv("AZURE_OPENAI_VERSION", "2023-05-15"),
        "AZURE_OPENAI_MODEL": os.getenv("AZURE_OPENAI_MODEL") or os.getenv("AZURE_OPENAI_DEPLOYMENT_NAME"),
    }
